...
description: "PikaORM Coercion: how Java types are translated from JDBC results, and how to register custom coercers."
active_page: coercion-system
permalink: /pages/coercion-system/
---
