...
description: "PikaORM Custom Mapping Pattern: using the static mapping() method to override table names, column names, and serialize complex types."
active_page: custom-mapping
permalink: /pages/custom-mapping/
---
