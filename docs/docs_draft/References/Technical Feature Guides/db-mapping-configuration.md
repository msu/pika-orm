...
See the [Custom Field Mapping]({{ site.baseurl }}/docs_draft/References/Technical%20Feature%20Guides/custom-field-mapping.md) guide for details on building class-specific mappings.
