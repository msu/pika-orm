...
See the [Query Caching Pattern]({{ site.baseurl }}/docs_draft/Patterns/Feature%20Patterns/query-caching-pattern.md) guide for a practical example of wrapping a web request in a caching block.
