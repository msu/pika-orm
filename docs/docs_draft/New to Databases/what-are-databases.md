...
Head over to [What is an ORM?]({{ site.baseurl }}/docs_draft/New%20to%20Databases/what-is-an-orm.md) to learn how Object Relational Mapping connects your Java code to your database.