...
Ready to see how PikaORM puts this into practice? Jump into the [Web Quickstart]({{ site.baseurl }}/docs_draft/Patterns/Example%20Projects/web-quickstart.md) to see a complete application example.
