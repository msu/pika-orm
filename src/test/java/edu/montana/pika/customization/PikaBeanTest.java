package edu.montana.pika.customization;

import edu.montana.pika.TestBase;
import edu.montana.pika.customization.model.BadModel;
import edu.montana.pika.models.BindableEPB;
...
public class PikaBeanTest extends TestBase {
